...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "96Fg8Ap7KhN9U6xlQiBpyZdLL", consumerSecret: "QTHCf3cvtxVeWgbE7Qv3Zlx9wI2JtekWMudjXR6Kaah94eSfyw")
    var loginSuccess: (() -> ())?
